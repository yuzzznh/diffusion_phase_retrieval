...
| 실험 | Particles | Optimization | **Best PSNR** ↑ | Best SSIM ↑ | Best LPIPS ↓ | Time (초) | VRAM (MB) |
|------|-----------|--------------|-----------------|-------------|--------------|-----------|-----------|
| **Exp0** (Baseline) | 4 (indep) | OFF | 17.50 | 0.550 | 0.558 | 9,060 | 10,161 |
| **Exp1** (Repulsion) | 4 | OFF | **17.62** (+0.12) | 0.538 | 0.570 | 9,173 | 10,252 |
| **Exp3** (2-particle) | 2 | OFF | 15.98 (-1.64) | 0.519 | 0.590 | **4,686** | **6,100** |
| **Exp4** (+Optimization) | 4 | ON | 17.31 (-0.31) | 0.488 | 0.558 | 10,941 | 10,258 |

#### 핵심 발견

**1. Exp0 vs Exp1: Repulsion 효과 ✅**
- Best PSNR: 17.50 → 17.62 (**+0.12 dB**)
- Repulsion이 약간의 성능 향상에 기여
- Mean Pairwise Distance: 74.3 (baseline ~32 대비 2.3배 증가)
- 시간/VRAM 오버헤드 미미 (+1.2%)

**2. Exp1 vs Exp3: 4-particle vs 2-particle ⭐**
- Best PSNR: 17.62 vs 15.98 (**-1.64 dB**)
- **4-particle이 확실히 우수** (10 images에서도 일관된 결과)
- 2-particle은 시간 49%, VRAM 40% 절약되지만 성능 손실 큼
- **결론**: "처음부터 2개만 쓰면 안 되나요?" → **No!** 4개로 넓게 탐색해야 함

**3. Exp1 vs Exp4: Optimization 역효과 ⚠️**
- Best PSNR: 17.62 → 17.31 (**-0.31 dB**)
- **Optimization이 오히려 성능 악화**
- 이유: Phase Retrieval에서 measurement loss ≠ PSNR (amplitude만, phase 없음)
- 시간 오버헤드: +1,768초 (+19%)
- **결론**: Phase Retrieval에서는 Optimization 비활성화 권장

#### 이미지별 Best PSNR 상세 비교

| Image | Exp0 | Exp1 | Exp3 | Exp4 | 최고 |
|-------|------|------|------|------|------|
| 0 | 14.92 | 13.84 | 11.81 | **17.86** | Exp4 |
| 1 | 19.35 | 16.81 | **17.17** | 17.04 | Exp0 |
| 2 | 15.12 | **13.82** | 13.56 | 14.17 | Exp0 |
| 3 | **19.39** | 16.48 | 15.90 | 15.31 | Exp0 |
| 4 | 13.93 | **17.57** | 13.02 | 18.94 | Exp4 |
| 5 | **18.51** | 18.56 | 15.59 | 18.57 | Exp1 |
| 6 | 20.78 | **24.01** | 20.61 | 20.53 | Exp1 |
| 7 | **19.21** | 21.03 | 18.41 | 14.21 | Exp1 |
| 8 | 10.28 | 11.13 | **10.39** | 10.29 | Exp1 |
| 9 | **23.48** | 22.98 | 23.36 | 26.21 | Exp4 |

- **Exp1이 우세한 이미지**: 5, 6, 7, 8 (4/10)
- **Exp0이 우세한 이미지**: 1, 2, 3 (3/10)
- **Exp4가 우세한 이미지**: 0, 4, 9 (3/10)
- 이미지별 편차가 크고, Best 선택 기준에 따라 결과 달라짐

#### 효율성 분석

| 실험 | 시간 (상대) | VRAM (상대) | PSNR (상대) |
|------|-------------|-------------|-------------|
| Exp0 | 100% | 100% | 100% |
| Exp1 | 101% | 101% | **101%** |
| Exp3 | **52%** | **60%** | 91% |
...
- **Exp1**: 시간/VRAM 동일, 성능 +1% → **Best Choice**
- **Exp3**: 시간/VRAM 절반, 성능 -9% → 효율성 우선 시 고려
- **Exp4**: 시간 +21%, 성능 -1% → **비추천**

#### 결과 폴더
- Exp0: `results/exp0_baseline/imagenet_10img/exp0_10img/`
- Exp1: `results/exp1_repulsion/imagenet_10img/exp1_10img_scale10/`
